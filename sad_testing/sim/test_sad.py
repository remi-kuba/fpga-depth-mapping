...
async def test_data_out(dut):
    w, h, left_img, right_img, depth, offsets = stereo_match("../../data/Tsukuba_L.png", "../../data/Tsukuba_R.png", 3, 10)
...
async def test_sad(dut):
    ...
    w, h, left_img, right_img, _, _ = stereo_match("../../data/Tsukuba_L.png", "../../data/Tsukuba_R.png", 3, 30)
